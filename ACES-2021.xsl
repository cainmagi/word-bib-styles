...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
            ...
            <xsl:when test="b:StyleNameLocalized">
                <xsl:choose>
                    ...
                    <xsl:when test="b:StyleNameLocalized/b:Lcid='1087'">
                        <xsl:text>Электр және электроника инженерлері институты - ACES</xsl:text>
                    </xsl:when>
                    ...
                    <xsl:when test="b:StyleNameLocalized/b:Lcid='1060'">
                        <xsl:text>Način citiranja IEEE - ACES</xsl:text>
                    </xsl:when>
                </xsl:choose>
            </xsl:when>
    ...
    <xsl:template name="templ_str_VersionShortUnCap" >
    ...
    <xsl:template name ="BibDisplayMonthYearConf">
    ...
    <xsl:template name="BibDisplayTitleMisc">
        <xsl:variable name="cTitle">
            <xsl:value-of select="count(b:Title)"/>
        </xsl:variable>
        <xsl:variable name="cEdition">
        ...
        <xsl:if test ="$cTitle!=0">
            <xsl:choose>
                <xsl:when test="$cAuthor=0 and $cEditor=0">
                    <xsl:call-template name="right-trim">
                        <xsl:with-param name ="s" select="b:Title"/>
                    </xsl:call-template>
                </xsl:when>
    ...
    <xsl:template name="BibDisplayVolumeJournal">
        ...
        <xsl:choose>
            <xsl:when test ="$cVolume!=0">
                <xsl:choose>
                    <xsl:when test=" contains($initValueOfVolume,',') ">
                    ...
                    <xsl:when test=" not(contains($initValueOfVolume,','))">
                        <xsl:call-template name ="templ_prop_Space"/>
    ...
    <xsl:template name="BibDisplayPagesConf">
        <xsl:variable name="cPages">
            <xsl:value-of select="count(b:Pages)"/>
        </xsl:variable>
        <xsl:variable name ="cMonthAccessed">
        ...
        <xsl:if test ="$cPages!=0">
            ...
            <xsl:choose>
                <xsl:when test="$cYear=0 and $cMonthAccessed=0">
                    <xsl:call-template name ="templ_prop_Dot"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:call-template name ="templ_prop_ListSeparator"/>
    ...
    <xsl:template name="BibDisplayOrganizationReport">
        <xsl:variable name="cDepartment">
            <xsl:value-of select="count(b:Department)"/>
        </xsl:variable>
        <xsl:variable name="cInstitution">
            <xsl:value-of select="count(b:Institution)"/>
        </xsl:variable>
        ...
        <xsl:choose>
            <xsl:when test = "$cDepartment!=0">
                <xsl:value-of select="b:Department"/>
                <xsl:if test = "$cInstitution!=0">
                    <xsl:call-template name ="templ_prop_ListSeparator"/>
                    <xsl:value-of select="b:Institution"/>
                </xsl:if>
            </xsl:when>
        ...
        <xsl:if test = "$cInstitution!=0">
            <xsl:choose>
                <xsl:when test=" $cPublisher!=0 or $cCity!=0 or $cYear!=0 ">
                    <xsl:call-template name ="templ_prop_ListSeparator"/>
                </xsl:when>
                <xsl:when test="$cPublisher=0 and $cCity=0 and $cYear=0">
                    <xsl:call-template name ="templ_prop_Dot"/>
                </xsl:when>
            </xsl:choose>
        </xsl:if>
    ...
    <xsl:template name="BibDisplayPublisherBC">
        ...
        <xsl:choose>
            <xsl:when test ="$cPublisher!=0">
                <xsl:value-of select="b:Publisher"/>
                <xsl:choose>
                    <xsl:when test=" $cStateProvince != 0 or $cCity != 0 or $cYear!=0 or $cPages!=0 " >
                        <xsl:call-template name ="templ_prop_ListSeparator"/>
                    </xsl:when>
                    <xsl:when test=" $cStateProvince=0 and $cCity=0 and $cYear=0 and $cPages=0 " >
                        <xsl:call-template name ="templ_prop_Dot"/>
                    </xsl:when>
                </xsl:choose>
            </xsl:when>
    ...
    <xsl:template name="BibDisplayEditionMisc">
        <xsl:variable name="cEdition">
            <xsl:value-of select="count(b:Edition)"/>
        </xsl:variable>
        <xsl:variable name="cVolume">
        ...
        <xsl:choose>
            <xsl:when test ="$cEdition!=0">
                <xsl:call-template name = "templ_str_VersionShortUnCap"/>
                <xsl:call-template name = "templ_prop_Space"/>
                <xsl:value-of select="b:Edition"/>
                <xsl:choose>
                    <xsl:when test="$cAuthors=0">
    ...
    <xsl:template name="BibDisplayMonthYearReport">
        <xsl:variable name = "cMonthAccessed">
            <xsl:value-of select = "count(b:MonthAccessed)"/>
        </xsl:variable>
        <xsl:variable name = "cYear">
                ...
                <xsl:element name="tr">
                    ...
                    <xsl:element name="td">
                        ...
                        <xsl:element name="p">
                            ...
                            <xsl:call-template name = "BibDisplayPagesConf"/>
                            <xsl:call-template name = "BibDisplayMonthYearConf"/>
                        </xsl:element>
                    </xsl:element>
                </xsl:element>
            </xsl:when>
                ...
                <xsl:element name="tr">
                    ...
                    <xsl:element name="td">
                        ...
                        <xsl:element name="p">
                            ...
                            <xsl:call-template name = "BibDisplayTitleMisc"/>
                            <xsl:call-template name = "BibDisplayEditionMisc"/>
                            <xsl:call-template name="BibDisplayVolumeBook"/>
                            <xsl:call-template name="BibDisplayEditor"/>
                            <xsl:call-template name = "BibDisplayPublisherBC"/>
                            <xsl:call-template name = "BibDisplayCity"/>
